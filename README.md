...
| Vulnerability | Endpoints Affected | Severity | Findings |
|---|---|---|---|
| SQL Injection | `brute/`, `sqli/` | HIGH | 14 |
| XSS | `xss_r/`, `xss_s/`, `sqli/`, `csp/` | HIGH | 4 |
| Weak Credentials | `brute/` | HIGH | 1 |
| Insecure Cookie | `login.php` | MEDIUM | 4 |
| IDOR | `idor/` | HIGH | Multiple |
